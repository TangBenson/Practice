...
//         string base64Latitude = "DvHAeA==";
//         string base64Longitude = "SHLNVg==";

//         byte[] latitudeBytes = Convert.FromBase64String(base64Latitude);
//         byte[] longitudeBytes = Convert.FromBase64String(base64Longitude);

//         string latitudeText = Encoding.UTF8.GetString(latitudeBytes);
//         string longitudeText = Encoding.UTF8.GetString(longitudeBytes);

//         Console.WriteLine("Latitude: " + latitudeText);
//         Console.WriteLine("Longitude: " + longitudeText);
//     }
// }
...
// {
//     // public List<DiscountLabelHistoryLog>? before { get; set; }
//     // public List<DiscountLabelHistoryLog>? after { get; set; }
